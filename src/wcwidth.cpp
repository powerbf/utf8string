/*
 * This is based on https://github.com/crawl/crawl/blob/master/crawl-ref/source/wcwidth.cc
 * which was itself based on  http://www.cl.cam.ac.uk/~mgk25/ucs/wcwidth.c
 * -----------------------------------------------------------------------
 *
